...
activities = {
    ...
    "Swimming Club": {
        "description": "Competitive and recreational swimming for all skill levels",
    ...
    "Math Olympiad": {
        "description": "Prepare for math competitions and develop advanced problem-solving skills",
